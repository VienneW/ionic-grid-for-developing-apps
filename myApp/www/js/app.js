...
angular.module('SimpleRESTIonic', ['ionic', 'backand', 'SimpleRESTIonic.controllers', 'SimpleRESTIonic.services'])
    ...
    .config(function (BackandProvider, $stateProvider, $urlRouterProvider, $httpProvider) {
        ...
        BackandProvider.setAppName('kwaifongshop'); // change here to your app name
        ...
        BackandProvider.setSignUpToken('0efee0f0-feea-4588-ac99-32a23f4c0979');
      BackandProvider.setAnonymousToken('e82f2b1f-08c7-4482-a914-f7c1fe8231aa');
